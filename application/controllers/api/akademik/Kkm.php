...
class Kkm extends REST_Controller
{
    ...
    public function update_post()
    {
        ...
        if ($this->form_validation->run() == true) {
            $this->set_response([
                'data' => $this->m_kkm->update($_POST, $_POST['id']),
            ], REST_Controller::HTTP_OK);
        } else {
            $this->set_response([
                'error' => validation_errors_json(),
    ...
    public function json_post()
    {
        ...
        $this->set_response(json_decode($this->m_kkm->json()), REST_Controller::HTTP_OK);
    }
    ...
    public function _rules(){
        ...
        $this->form_validation->set_rules('id_user', 'guru', 'trim|required');
    ...
    public function file_post($id)
    {
            ...
            $this->set_response([
                'data' => $this->m_kkm->update($_POST, $id),
            ], REST_Controller::HTTP_OK);
    }

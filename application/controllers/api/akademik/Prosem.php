...
class Prosem extends REST_Controller
{
    ...
    public function create_post()
    {
        ...
        if ($this->form_validation->run() == true) {
            $this->set_response([
                'data' => $this->m_prosem->create($_POST),
    ...
    public function update_post()
    {
        ...
        if ($this->form_validation->run() == true) {
            $this->set_response([
                'data' => $this->m_prosem->update($_POST, $_POST['id']),
            ], REST_Controller::HTTP_OK);
        } else {
            $this->set_response([
                'error' => validation_errors_json(),
    ...
    public function json_post()
    {
        ...
        $this->set_response(json_decode($this->m_prosem->json()), REST_Controller::HTTP_OK);
    }
    ...
    public function file_post($id)
    {
            ...
            $this->set_response([
                'data' => $this->m_prosem->update($_POST, $id),
            ], REST_Controller::HTTP_OK);
    }

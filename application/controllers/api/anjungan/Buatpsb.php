...
class Buatpsb extends REST_Controller
{
    ...
    public function create_post()
    {
        ...
        if ($this->form_validation->run() == true) {
            $this->set_response([
                'data' => $this->m_buatpsb->create($_POST),
    ...
    {
        $this->set_response([
            'data' => $this->m_buatpsb->read($_POST),
        ], REST_Controller::HTTP_OK);
    }
    ...
    public function update_post()
    {
        ...
        if ($this->form_validation->run() == true) {
            $this->set_response([
                'data' => $this->m_buatpsb->update($_POST, $_POST['id']),
            ], REST_Controller::HTTP_OK);
        } else {
            $this->set_response([
                'error' => validation_errors_json(),
    ...
    public function json_post()
    {
        ...
        $this->set_response(json_decode($this->m_buatpsb->json()), REST_Controller::HTTP_OK);
    }

...
class Kegiatan_diluar extends REST_Controller
{
    ...
    public function create_post()
    {
        ...
        if ($this->form_validation->run() == true) {
            $this->set_response([
                'data' => $this->m_kegiatan_diluar->create($_POST),
    ...
    {
        $this->set_response([
            'data' => $this->m_kegiatan_diluar->read($_POST),
        ], REST_Controller::HTTP_OK);
    }
    ...
    public function update_post()
    {
        ...
        if ($this->form_validation->run() == true) {
            $this->set_response([
                'data' => $this->m_kegiatan_diluar->update($_POST, $_POST['id']),
            ], REST_Controller::HTTP_OK);
        } else {
            $this->set_response([
                'error' => validation_errors_json(),
    ...
    {
        $this->set_response([
            'data' => $this->m_kegiatan_diluar->delete($id),
        ], REST_Controller::HTTP_OK);
    }
    ...
    public function json_post()
    {
        ...
        $this->set_response(json_decode($this->m_kegiatan_diluar->json()), REST_Controller::HTTP_OK);
    }

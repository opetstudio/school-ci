...
class Pelanggaran_siswa extends REST_Controller
{
    ...
    public function create_post()
    {
        ...
        if ($this->form_validation->run() == true) {
            $this->set_response([
                'data' => $this->m_pelanggaran_siswa->create($_POST),
    ...
    {
        $this->set_response([
            'data' => $this->m_pelanggaran_siswa->read($_POST),
        ], REST_Controller::HTTP_OK);
    }
    ...
    public function update_post()
    {
        ...
        if ($this->form_validation->run() == true) {
            $this->set_response([
                'data' => $this->m_pelanggaran_siswa->update($_POST, $_POST['id']),
            ], REST_Controller::HTTP_OK);
        } else {
            $this->set_response([
                'error' => validation_errors_json(),
    ...
    {
        $this->set_response([
            'data' => $this->m_pelanggaran_siswa->delete($id),
        ], REST_Controller::HTTP_OK);
    }
    ...
    public function json_post()
    {
        ...
        $this->set_response(json_decode($this->m_pelanggaran_siswa->json()), REST_Controller::HTTP_OK);
    }

...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>AdminLTE-2.4.10/bower_components/font-awesome/css/font-awesome.min.css">
    <!-- Ionicons -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>AdminLTE-2.4.10/bower_components/Ionicons/css/ionicons.min.css">
    <!-- Theme style -->
      ...
      <div class="error-page">
        ...
        <div class="error-content">
          ...
          <p>
            ...
            Meanwhile, you may <a href="<?php echo base_url(); ?>admin/dashboard/index">return to dashboard</a> or try using the search form.
          </p>

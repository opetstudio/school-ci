<form id="dokumenForm" method="post" action="<?=base_url('api/transaksi/dokumen/'.$action); ?>" class="form-horizontal">
        ...
        if (id) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('iframe').contents().find('.wysihtml5-editor').html(data.data[0].keterangan);
                }
            })
        }
    }

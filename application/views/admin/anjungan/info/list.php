        ...
        if ($.fn.dataTable.isDataTable("#mytable")) {
            ...
            $('#mytable').DataTable({
                ...
                buttons: [{
                    ...
                    init: function(a, b, c) {
                        b.attr('href', __base_url + 'admin/anjungan/info/createnote');
                        b.attr('title', 'CREATE');
                    },
                }, ],
                "processing": true,
                "serverSide": true,
                "ajax": {
                    "url": __base_url + "api/anjungan/info/json",
                    "type": "POST",
                    "headers": {
        ...
        if ($.fn.dataTable.isDataTable("#mytable2")) {
            ...
            $('#mytable2').DataTable({
                ...
                buttons: [{
                    ...
                    className: "btn btn-create btn-success fa fa-plus",
                    init: function(a, b, c) {
                        b.attr('href', __base_url + 'admin/anjungan/info/creategaleri');
                        b.attr('title', 'CREATE');
                    },
                }, ],
                "processing": true,
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        "render": function(row, data, iDisplayIndex) {
                            var result = "";
                            result += "<button href=\"" + __base_url +
                                "admin/anjungan/info/readgaleri/" +
                                iDisplayIndex.id +
                                "\" class=\"btn btn-info btn-read btn-xs\" title=\"Read\"><i class=\"fa fa-eye\"></i> Read</button>";

                            result += "<button href=\"" + __base_url +
                                "admin/anjungan/info/updategaleri/" +
                                iDisplayIndex.id +
                                "\" class=\"btn btn-warning btn-update btn-xs\" title=\"Update\"><i class=\"fa fa-pencil\"></i> Update</button>";
        ...
        if ($.fn.dataTable.isDataTable("#mytable3")) {
            ...
            $('#mytable3').DataTable({
                ...
                buttons: [{
                    ...
                    className: "btn btn-create btn-success fa fa-plus",
                    init: function(a, b, c) {
                        b.attr('href', __base_url + 'admin/anjungan/info/createvideo');
                        b.attr('title', 'CREATE');
                    },
                }, ],
                "processing": true,
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        "render": function(row, data, iDisplayIndex) {
                            var result = "";
                            result += "<button href=\"" + __base_url +
                                "admin/anjungan/info/readvideo/" +
                                iDisplayIndex.id +
                                "\" class=\"btn btn-info btn-read btn-xs\" title=\"Read\"><i class=\"fa fa-eye\"></i> Read</button>";

                            result += "<button href=\"" + __base_url +
                                "admin/anjungan/info/updatevideo/" +
                                iDisplayIndex.id +
                                "\" class=\"btn btn-warning btn-update btn-xs\" title=\"Update\"><i class=\"fa fa-pencil\"></i> Update</button>";

...
$(document).ready(function() {
    ...
    $('#mytable').DataTable({
        ...
        buttons: [{
            ...
            init: function(a, b, c) {
                b.attr('href', __base_url + 'admin/elibrary/buku/create');
                b.attr('title', 'CREATE');
            },
        }, ],
        "processing": true,

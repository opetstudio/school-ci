<table id="mytable" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%">
    <thead>
        <tr>
            <th>No</th>
            <th class="detail_prosem">Detail Prosem</th>
            <th class="aw_1">Detail Alokasi Waktu 1</th>
            <th class="aw_2">Detail Alokasi Waktu 2</th>
            <th>Is Active</th>
            <th>Created By</th>
            <th>Created Date</th>
            <th>Updated By</th>
...
$(document).ready(function() {
    ...
    $('#mytable').DataTable({
        ...
        buttons: [{
            ...
            init: function(a, b, c) {
                b.attr('href', __base_url + 'admin/akademik/detail_prosem/create/'+id_prosem);
                b.attr('title', 'CREATE');
            },
        }, ],
        "processing": true,
        "serverSide": true,
        "ajax": {
            "url": __base_url + "api/akademik/detail_prosem/json/"+id_prosem,
            "type": "POST",
            "headers": {
                'Authorization': localStorage.getItem("token")
            },
        ...
        "columns": [{
            ...
            },
            {
                ...
                "render": function(row, data, iDisplayIndex) {
                    var result = "";
                    // result += "<button href=\"" + __base_url + "admin/akademik/detail_prosem/read/" +
                    //     iDisplayIndex.id + "/" + id_prosem +
                    //     "\" class=\"btn btn-info btn-read btn-xs\" title=\"Read\"><i class=\"fa fa-eye\"></i> Read</button>";
                    result += "<button href=\"" + __base_url + "admin/akademik/detail_prosem/update/" +
                        iDisplayIndex.id + "/" + id_prosem +
                        "\" class=\"btn btn-warning btn-update btn-xs\" title=\"Update\"><i class=\"fa fa-pencil\"></i> Update</button>";
                    result += "<button href=\"" + __base_url + "admin/akademik/detail_prosem/delete/" +
                        iDisplayIndex.id + "/" + id_prosem +

...
$(document).ready(function() {
    ...
    var foto_upload = new Dropzone(".dropzone", {
        url: ($('#kkmForm').attr('action') + '/' + $('#kkmForm input[name="id"]').val()),
        // params: ,
        method: 'POST',
        headers: {
        ...
        init: function() {
            ...
            attach.forEach(function(a, b) {
                var src = '<?= base_url(PATH_PUBLIC_ATTACH . 'kkm/') ?>' + a;
                ...
                setTimeout(() => {
                    $('.dropzone .dz-details').attr('path','<?= base_url(PATH_PUBLIC_ATTACH . 'kkm/') ?>')
                }, 300);
            })
            ...
            this.on("removedfile", function(a) {
                ...
                $.ajax({
                    ...
                    url: '<?= base_url('api/akademik/kkm/deletefile/') ?>' + a._removeLink.id,
                    // cache: false,
                    //                        dataType: 'json',

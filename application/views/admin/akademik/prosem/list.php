...
$(document).ready(function() {
    ...
    $('#mytable').DataTable({
        ...
        buttons: [{
            ...
            init: function(a, b, c) {
                b.attr('href', __base_url + 'admin/akademik/prosem/create');
                b.attr('title', 'CREATE');
            },
        }, ],
        "processing": true,
        "serverSide": true,
        "ajax": {
            "url": __base_url + "api/akademik/prosem/json",
            "type": "POST",
            "headers": {
            ...
            },
            {
                ...
                render: function(row, data, iDisplayIndex) {
                    if(iDisplayIndex.file){
                        return '<a href="'+ __base_url + 'assets/public/attach/prosem/' + iDisplayIndex.file+'" target="_blank">' + iDisplayIndex.file+'</a>';
                    } else {

...
$(document).ready(function() {
    ...
    $('#mytable').DataTable({
        ...
        buttons: [{
            ...
            init: function(a, b, c) {
                b.attr('href', __base_url + 'admin/akademik/nilai_harian/create/'+id_nilai_siswa);
                b.attr('title', 'CREATE');
            },
        }, ],
        "processing": true,
        "serverSide": true,
        "ajax": {
            "url": __base_url + "api/akademik/nilai_harian/json/"+id_nilai_siswa,
            "type": "POST",
            "headers": {
                'Authorization': localStorage.getItem("token")
            },
        ...
        "columns": [{
            ...
            },
            {
                ...
                "render": function(row, data, iDisplayIndex) {
                    var result = "";
                    result += "<button href=\"" + __base_url + "admin/akademik/nilai_harian/update/" +
                        iDisplayIndex.id + "/" + id_nilai_siswa +
                        "\" class=\"btn btn-warning btn-update btn-xs\" title=\"Update\"><i class=\"fa fa-pencil\"></i> Update</button>";
                    result += "<button href=\"" + __base_url + "admin/akademik/nilai_harian/delete/" +
                        iDisplayIndex.id + "/" + id_nilai_siswa +

...
$(document).ready(function() {
    ...
    $('#mytable').DataTable({
        ...
        buttons: [{
            ...
            init: function(a, b, c) {
                b.attr('href', __base_url + 'admin/akademik/rpp/create');
                b.attr('title', 'CREATE');
            },
        }, ],
        "processing": true,
        "serverSide": true,
        "ajax": {
            "url": __base_url + "api/akademik/rpp/json",
            "type": "POST",
            "headers": {
            ...
            },
            {
                ...
                render: function(row, data, iDisplayIndex) {
                    if(iDisplayIndex.file){
                        return '<a href="'+ __base_url + 'onlyoffice/view/' + iDisplayIndex.file+'?key='+iDisplayIndex.file+'&action=rpp" target="_blank">' + iDisplayIndex.file+'</a>';
                    } else {

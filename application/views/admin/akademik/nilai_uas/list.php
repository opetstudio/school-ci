...
$(document).ready(function() {
    var form = '#nilaiUasForm';
    var id_nilai_siswa = parseInt("<?= $id_nilai_siswa ?>");
    ...
    function getPenilaian(){
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#nama_siswa").text(data.data[0].nama_siswa);
    ...
    $('#mytable').DataTable({
        ...
        buttons: [{
            ...
            init: function(a, b, c) {
                b.attr('href', __base_url + 'admin/akademik/nilai_uas/create/'+id_nilai_siswa);
                b.attr('title', 'CREATE');
            },
        }, ],
        "processing": true,
        "serverSide": true,
        "ajax": {
            "url": __base_url + "api/akademik/nilai_uas/json/"+id_nilai_siswa,
            "type": "POST",
            "headers": {
                'Authorization': localStorage.getItem("token")
            },
        ...
        "columns": [{
            ...
            },
            {
                ...
                "render": function(row, data, iDisplayIndex) {
                    var result = "";
                    result += "<button href=\"" + __base_url + "admin/akademik/nilai_uas/update/" +
                        iDisplayIndex.id + "/" + id_nilai_siswa +
                        "\" class=\"btn btn-warning btn-update btn-xs\" title=\"Update\"><i class=\"fa fa-pencil\"></i> Update</button>";
                    result += "<button href=\"" + __base_url + "admin/akademik/nilai_uas/delete/" +
                        iDisplayIndex.id + "/" + id_nilai_siswa +

...
$(document).ready(function() {
    ...
    $('#mytable').DataTable({
        ...
        buttons: [{
            ...
            init: function(a, b, c) {
                b.attr('href', __base_url + 'admin/master/banner/create');
                b.attr('title', 'CREATE');
            },
        }, ],
        "processing": true,
        "serverSide": true,
        "ajax": {
            "url": __base_url + "api/master/banner/json",
            "type": "POST",
            "headers": {
        ...
        "columns": [{
            ...
            {
                "data": "tanggal_mulai_name"
            },
            {
                "data": "tanggal_selesai_name"
            },
            {
                "data": "note"
            },
            ...
            //         var html = "";
            //         if(iDisplayIndex.attach){
            //             html = '<a href="<?= base_url(PATH_PUBLIC_ATTACH . 'banner/') ?>'+iDisplayIndex.attach+'" target="_blank">'+iDisplayIndex.nama+'</a>';
            //         }
            //         return html;
            //     }
            // },
    ...
    $(document).on('click', form + ' .btn-save', function(e) {
        ...
        if (value.tanggal_mulai) {
            value.tanggal_mulai = moment(value.tanggal_mulai, "DD/MM/YYYY").format("YYYY/MM/DD")
        }
        if (value.tanggal_selesai) {
            value.tanggal_selesai = moment(value.tanggal_selesai, "DD/MM/YYYY").format("YYYY/MM/DD")
        }
        $.ajax({

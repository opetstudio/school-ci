<form id="bannerForm" method="post" action="<?=base_url('api/master/banner/'.$action); ?>" class="form-horizontal">
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            <select name="flag" class="form-control chosen">
                <option value="">Select</option>
                <?php foreach ($this->m_banner->flaging as $key => $value) { ?>
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            <div class="input-group date onlydatepicker">
                <input name="tanggal_mulai" class="form-control">
    ...
    <div class="form-group">
        ...
        <div class="col-md-9">
            <div class="input-group date onlydatepicker">
                <input name="tanggal_selesai" class="form-control">
                <span class="input-group-addon">
                    <span class="glyphicon glyphicon-calendar"></span>
                </span>
            </div>
...
$(document).ready(function() {
    ...
    function getDatabyId() {
        ...
        if (id) {
            $.ajax({
                url: __base_url + "api/master/banner/read",
                data: {
                    id: id
                },
                method: "POST",
                ...
                success: function(data) {
                    $.each(data.data, function(i, value) {
                        ...
                        $(form + ' input[name="tanggal_mulai"]').val(value
                            .tanggal_mulai_name);
                        $(form + ' input[name="tanggal_selesai"]').val(value
                            .tanggal_selesai_name);
                    });
                }
            })
        }

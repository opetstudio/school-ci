...
$(document).ready(function() {
    ...
    $('#mytable').DataTable({
        ...
        buttons: [{
            ...
            init: function(a, b, c) {
                b.attr('href', __base_url + 'admin/master/user/create');
                b.attr('title', 'CREATE');
            },
        }, ],
        "processing": true,
        "serverSide": true,
        "ajax": {
            "url": __base_url + "api/master/user/json",
            "type": "POST",
            "headers": {
            ...
            },
            {
                ...
                "render": function(row, data, iDisplayIndex) {
                    ...
                    result += "<button href=\"" + __base_url +
                        "admin/master/user/file/" +
                        iDisplayIndex.id +
                        "\" class=\"btn btn-success btn-update btn-xs\" title=\"Foto\"><i class=\"fa fa-pencil\"></i> Foto</button>";

                    result += "<button href=\"" + __base_url + "admin/master/user/resetpassword/" +
                        iDisplayIndex.id +
                        "\" class=\"btn bg-orange btn-read btn-xs\" title=\"Reset Password\"><i class=\"fa fa-fa-cog\"></i> Reset Password</button>";
                    result += "<button href=\"" + __base_url + "admin/master/user/read/" +
                        iDisplayIndex.id +
                        "\" class=\"btn btn-info btn-read btn-xs\" title=\"Read\"><i class=\"fa fa-eye\"></i> Read</button>";
                    result += "<button href=\"" + __base_url + "admin/master/user/update/" +
                        iDisplayIndex.id +
                        "\" class=\"btn btn-warning btn-update btn-xs\" title=\"Update\"><i class=\"fa fa-pencil\"></i> Update</button>";
                    result += "<button href=\"" + __base_url + "admin/master/user/delete/" +
                        iDisplayIndex.id +

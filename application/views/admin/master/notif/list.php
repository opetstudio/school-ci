...
$(document).ready(function() {
    ...
    $('#mytable').DataTable({
        ...
        buttons: [{
            ...
            init: function(a, b, c) {
                b.attr('href', __base_url + 'admin/master/notif/create');
                b.attr('title', 'CREATE');
            },
        }, ],
        "processing": true,
        "serverSide": true,
        "ajax": {
            "url": __base_url + "api/master/notif/json",
            "type": "POST",
            "headers": {
        ...
        "columns": [{
            ...
            //             html = '<a href="< ?= base_url(PATH_PUBLIC_ATTACH . 'notif/') ?>'+iDisplayIndex.attach+'" target="_blank">'+iDisplayIndex.nama+'</a>';
            //         }
            //         return html;
            //     }
            // },
    ...
    $(document).on('click', form + ' .btn-save', function(e) {
        ...
        if (value.tanggal) {
            value.tanggal = moment(value.tanggal, "DD/MM/YYYY HH:mm:ss").format("YYYY-MM-DD HH:mm:ss")
        }
        $.ajax({

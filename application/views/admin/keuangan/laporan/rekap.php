        ...
        $.ajax({
            ...
            success: function(data) {
                $.each(data.data,function (i,value) {
                    $('#mytableform').append('<tr class="'+value.id+'"><td>'+value.kode+'</td><td>'+value.name+'</td><td></td><td></td><td></td></tr>');
                })
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        $.each(data.data,function (i,value) {
                            $('#mytableform .' + value.id_kode_gl).after('<tr class="'+value.id+'"><td></td><td>'+value.kode+'</td><td>'+value.jenis+'</td><td></td><td></td></tr>');
                        })
                    }
                })

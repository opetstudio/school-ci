...
$(document).ready(function() {
    ...
    $('#mytable').DataTable({
        ...
        buttons: [{
            ...
            init: function(a, b, c) {
                b.attr('href', __base_url + 'admin/keuangan/cashlesspayment/create');
                b.attr('title', 'CREATE');
            },
        }, ],
        "processing": true,
        "serverSide": true,
        "ajax": {
            "url": __base_url + "api/keuangan/cashlesspayment/json",
            "type": "POST",
            "headers": {
        ...
        "columns": [{
            ...
            //         var result = "";
            //         result += "<button href=\"" + __base_url + "admin/keuangan/cashlesspayment/read/" +
            //             iDisplayIndex.id +
            //             "\" class=\"btn btn-info btn-read btn-xs\" title=\"Read\"><i class=\"fa fa-eye\"></i> Read</button>";
            //         // result += "<button href=\"" + __base_url + "admin/keuangan/cashlesspayment/update/" +
            //         //     iDisplayIndex.id +
            //         //     "\" class=\"btn btn-warning btn-update btn-xs\" title=\"Update\"><i class=\"fa fa-pencil\"></i> Update</button>";
            //         // result += "<button href=\"" + __base_url + "admin/keuangan/cashlesspayment/delete/" +
            //         //     iDisplayIndex.id +
    ...
    $(document).on('click','.btn-pilihuser',function (e) {
        var data = JSON.parse($(this).attr('data'));
        console.log(data)
        $(form + ' input[name="nama_user"]').val(data.name);
        $(form + ' input[name="id_user"]').val(data.id);
        // $(form + ' input[name="id_kls"]').val(data.id);

        $('#myModaluser .close').trigger('click');
    })

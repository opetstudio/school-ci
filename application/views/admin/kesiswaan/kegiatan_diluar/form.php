<form id="kegiatanDiluarForm" method="post" action="<?=base_url('api/kesiswaan/kegiatan_diluar/'.$action); ?>" class="form-horizontal">
...
$(document).ready(function() {
    ...
    function getDatabyId() {
        ...
        if (id) {
            $.ajax({
                url: __base_url + "api/kesiswaan/kegiatan_diluar/read",
                data: {
                    id: id
                },
                method: "POST",

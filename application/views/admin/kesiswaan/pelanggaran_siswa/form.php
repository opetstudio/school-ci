<form id="pelanggaranSiswaForm" method="post" action="<?=base_url('api/kesiswaan/pelanggaran_siswa/'.$action); ?>"
        ...
        <div class="col-md-9">
            <div class="input-group input-group-sm">
                ...
                <span class="input-group-btn">
                    <button type="button"
                        class="btn btn-info btn-flat btn-carisiswa <?= !empty($id) ? 'readonlyyy' : '' ?>" disabled>Cari!</button>
                </span>
            </div>
            <span class="help-block"></span>
        </div>
    ...
    <div class="form-group">
        <label class="col-md-3"> Pelanggaran</label>
        <div class="col-md-9">
    ...
    <div class="form-group">
        <label class="col-md-3"> Sanksi</label>
        <div class="col-md-9">

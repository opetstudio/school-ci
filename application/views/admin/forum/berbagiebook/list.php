...
$(document).ready(function() {
    ...
    $('#mytable').DataTable({
        ...
        buttons: [{
            ...
            init: function(a, b, c) {
                b.attr('href', __base_url + 'admin/forum/berbagiebook/create');
                b.attr('title', 'CREATE');
            },
        }, ],
        "processing": true,
        "serverSide": true,
        "ajax": {
            "url": __base_url + "api/forum/berbagi/json",
            "type": "POST",
            "headers": {
            ...
            },
            {
                ...
                "render": function(row, data, iDisplayIndex){
                    ...
                    if(iDisplayIndex.attach){
                        html = '<a href="<?= base_url(PATH_PUBLIC_ATTACH . 'berbagi/') ?>'+iDisplayIndex.attach+'" target="_blank">'+iDisplayIndex.nama+'</a>';
                    }
                    return html;
                }
            },
            ...
            },
            {
                ...
                "render": function(row, data, iDisplayIndex) {
                    ...
                    result += "<button href=\"" + __base_url +
                        "admin/forum/berbagiebook/read/" +
                        iDisplayIndex.id +
                        "\" class=\"btn btn-info btn-read btn-xs\" title=\"Read\"><i class=\"fa fa-eye\"></i> Read</button>";
                    result += "<button href=\"" + __base_url +
                        "admin/forum/berbagiebook/update/" +
                        iDisplayIndex.id +
                        "\" class=\"btn btn-warning btn-update btn-xs\" title=\"Update\"><i class=\"fa fa-pencil\"></i> Update</button>";
                    result += "<button href=\"" + __base_url +
                        "admin/forum/berbagiebook/file/" +
                        iDisplayIndex.id +
                        "\" class=\"btn btn-success btn-update btn-xs\" title=\"Ebook\"><i class=\"fa fa-pencil\"></i> Ebook</button>";

                    result += "<button href=\"" + __base_url + "admin/forum/berbagi/delete/" +
                        iDisplayIndex.id +

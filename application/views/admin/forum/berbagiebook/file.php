<form id="bagiebookForm" method="post" action="<?=base_url('api/forum/berbagi/'.$action); ?>" class="form-horizontal">
...
$(document).ready(function() {
    ...
    var foto_upload = new Dropzone(".dropzone", {
        url: ($('#bagiebookForm').attr('action') + '/' + $('#bagiebookForm input[name="id"]').val()),
        // params: ,
        method: 'POST',
        headers: {
        ...
        init: function() {
            ...
            $.ajax({
                ...
                url: '<?= base_url('api/forum/berbagi/deletefile/') ?>' + a._removeLink.id,
                // cache: false,
                //                        dataType: 'json',

<form id="bagivideoForm" method="post" action="<?=base_url('api/forum/forum/'.$action); ?>" class="form-horizontal">
    ...
    var foto_upload = new Dropzone(".dropzone", {
        ...
        init: function() {
            ...
            $.ajax({
                ...
                url: '<?= base_url('api/forum/forum/deletefile/') ?>' + a._removeLink.id,
                // cache: false,
                //                        dataType: 'json',

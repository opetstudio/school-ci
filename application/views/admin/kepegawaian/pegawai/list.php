...
$(document).ready(function() {
    ...
    $('#mytable').DataTable({
        ...
        buttons: [{
            ...
            init: function(a, b, c) {
                b.attr('href', __base_url + 'admin/kepegawaian/pegawai/create');
                b.attr('title', 'CREATE');
            },
        }, ],
        "processing": true,
        "serverSide": true,
        "ajax": {
            "url": __base_url + "api/kepegawaian/pegawai/json",
            "type": "POST",
            "headers": {
        ...
        "columns": [{
            ...
            {               
                ...
                "render": function(row, data, iDisplayIndex) {
                    var result = "";
                    result += "<button href=\"" + __base_url + "admin/kepegawaian/pegawai/read/" +
                        iDisplayIndex.id +
                        "\" class=\"btn btn-info btn-read btn-xs\" title=\"Read\"><i class=\"fa fa-eye\"></i> Read</button>";
                    result += "<button href=\"" + __base_url + "admin/kepegawaian/pegawai/update/" +
                        iDisplayIndex.id +
                        "\" class=\"btn btn-warning btn-update btn-xs\" title=\"Update\"><i class=\"fa fa-pencil\"></i> Update</button>";
                    result += "<button href=\"" + __base_url + "admin/kepegawaian/pegawai/delete/" +
                        iDisplayIndex.id +

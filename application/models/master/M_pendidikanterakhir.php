...
class M_pendidikanterakhir extends CI_Model
{
    ...
    public $sql = "
                        ...
                        from app_pendd_last apl
                        left join app_user muc on muc.id = apl.created_by
                        left join app_user muu on muu.id = apl.updated_by
    ";
    public $where = [' apl.is_active != 9 '];
    public $add_params = [
        'created_by_name' => 'muc.name',
        'updated_by_name' => 'muu.name',
    ];

    public $select = 'id,pendd,is_active,is_active_name,created_dt,created_by_name,updated_dt,updated_by_name';

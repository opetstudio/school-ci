...
class M_kegiatan_diluar extends CI_Model
{
    ...
    public $select = 'id, jurusan, nama_kelas, semester, tanggal, tanggal_name, pkl_mulai, pkl_selesai, kegiatan, lokasi, is_active, is_active_name,created_dt,created_by_name,updated_dt,updated_by_name';

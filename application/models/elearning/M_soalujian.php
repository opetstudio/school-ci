...
{
    public $table = 'app_elearning_soalujian';
    public $alias = 'mst';
    public $id = 'id';
    public $order = 'DESC';
    public $limit = 20;
    public $sql = "
                    select * from (
                        ...
                        from app_elearning_soalujian abk
    ...
    public $select = 'id, id_jurusan, id_kelas, id_mapel, id_semester, id_tahun_ajaran, judul, flag,file,ket,
    sekolah,nama_kelas,semester,tahun,jurusan,mapel,mulai_name,selesai_name,durasi,
    ...
    {
        $qty = findOne("SELECT (lihat + 1) as lihat FROM app_soalujian where id = " . $_POST['id']);

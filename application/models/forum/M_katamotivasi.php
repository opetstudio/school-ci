...
class M_katamotivasi extends CI_Model
{
    public $table = 'app_kata_motivasi';
    public $alias = 'akm';
    public $id = 'id';
    public $order = 'DESC';
    public $limit = 20;
    public $sql = "
                    select * from (
                        ...
                        DATE_FORMAT(akm.created_dt, '%d/%m/%Y %H:%i:%s') as created_dt_name,
                        DATE_FORMAT(akm.updated_dt, '%d/%m/%Y %H:%i:%s') as updated_dt_name,
                        ask.nm_skl as sekolah
                        from app_kata_motivasi akm
                        ...
                        where akm.is_active != 9 and ask.is_active = 1
                    ) as mst
    ";
    public $where = [];
    public $add_params = [];

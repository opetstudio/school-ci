...
class M_kode_gl extends CI_Model
{
    ...
    public $select = 'id, pembayaran, ket, is_active_name,created_dt,created_by_name,updated_dt,updated_by_name';

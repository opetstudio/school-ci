...
class M_nilai_harian extends CI_Model
{
    public $table = 'app_nilai_harian';
    public $alias = 'mst';
    public $id = 'id';
    public $order = 'DESC';
    public $limit = 20;
    ...
    public $select = 'id, id_nilai_siswa, nilai_harian, keterangan, is_active,is_active_name,created_dt,created_by_name,updated_dt,updated_by_name';

...
class M_dataortu extends CI_Model
{
    ...
    public $select = '
    id, nm_ayah, pg_ayah, tmp_lhr_ayah, tgl_lhr_ayah, agm_ayah, wrg_ayah, wrg_ayah_lain, 
    id_pndd_ayah, pnddk_ayah, id_pek_ayah, pek_ayah_lain, jbt_ayah, gaji_ayah, almt_knt_ayah, almt_rmh_ayah, telp, ket, 
    
    nm_ibu, pg_ibu, tmp_lhr_ibu, tgl_lhr_ibu, agm_ibu, wrg_ibu, wrg_ibu_lain, 
    id_pndd_ibu, pndd_ibu, id_pek_ibu, pek_ibu_lain, jbt_ibu, gaji_ibu, almt_knt_ibu, almt_rmh_ibu, telp_ibu, ket_ibu, 
    
    foto_ayah, foto_ibu, id_siswa, id_skl,

    tgl_lhr_ayah_name,tgl_lhr_ibu_name,
